...
BC_CONSTEXPR size_t TOKEN_CERT_FIX_SIZE = (TOKEN_CERT_SYMBOL_FIX_SIZE
    + TOKEN_CERT_OWNER_FIX_SIZE + TOKEN_CERT_ADDRESS_FIX_SIZE
    + TOKEN_CERT_TYPE_FIX_SIZE + TOKEN_CERT_STATUS_FIX_SIZE);
