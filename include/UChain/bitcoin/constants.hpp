...
BC_CONSTEXPR uint64_t min_fee_to_issue_token       = 10000 * 100000000L;
BC_CONSTEXPR uint64_t min_lock_to_issue_candidate  = 500000 * 100000000L;
BC_CONSTEXPR uint64_t min_fee_to_register_uid      = 100 * 100000000L;
