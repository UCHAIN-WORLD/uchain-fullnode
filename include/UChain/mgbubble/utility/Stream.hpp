/*
 * Copyright (c) 2018-2020 UChain core developers (see UC-AUTHORS) - UChain.
 *
...
#include <ostream>
#include <UChain/mgbubble/compat/define.hpp>
#include <UChain/mgbubble/compat/string_view.h>
