...
class BCD_API blockchain_asset_cert_database
{
public:
    /// Construct the database.
    blockchain_asset_cert_database(const boost::filesystem::path& map_filename,
    ...
    std::shared_ptr<asset_cert> get(const hash_digest& hash) const;
