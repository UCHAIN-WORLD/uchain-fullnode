...
//#include <UChain/bitcoin/chain/attachment/account/address_asset.hpp>
...
//      + std::max({UCN_FIX_SIZE, ASSET_DETAIL_FIX_SIZE, ASSET_TRANSFER_FIX_SIZE});
