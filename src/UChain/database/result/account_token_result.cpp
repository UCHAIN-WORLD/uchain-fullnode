 ...
 */
#include <UChain/database/result/account_token_result.hpp>
...
account_token_result::account_token_result(const memory_ptr slab)
  : base_result(slab)
{
}

token_transfer account_token_result::get_account_token_transfer() const
{
